<template>
  ...
  const tableData = ref([
    ...
    { id: 31, name: "Rahim", email: "rahim@example.com", phone: "1234567890" },
    { id: 32, name: "Karim", email: "karim@example.com", phone: "9876543210" },
    { id: 33, name: "Abdullah", email: "abdullah@example.com", phone: "5556667778" },
    { id: 34, name: "Sajjad", email: "sajjad@example.com", phone: "2223334445" },
    { id: 35, name: "Rakib", email: "rakib@example.com", phone: "1112223334" },
    { id: 36, name: "Jamil", email: "jamil@example.com", phone: "6667778889" },
    { id: 37, name: "Faruk", email: "faruk@example.com", phone: "4445556667" },
    { id: 38, name: "Sumon", email: "sumon@example.com", phone: "9990001112" },
    { id: 39, name: "Bashir", email: "bashir@example.com", phone: "7778889990" },
    { id: 40, name: "Nadim", email: "nadim@example.com", phone: "3334445556" },
    { id: 41, name: "Rahim", email: "rahim@example.com", phone: "1234567890" },
    { id: 42, name: "Karim", email: "karim@example.com", phone: "9876543210" },
    { id: 43, name: "Abdullah", email: "abdullah@example.com", phone: "5556667778" },
    { id: 44, name: "Sajjad", email: "sajjad@example.com", phone: "2223334445" },
    { id: 45, name: "Rakib", email: "rakib@example.com", phone: "1112223334" },
    { id: 46, name: "Jamil", email: "jamil@example.com", phone: "6667778889" },
    { id: 47, name: "Faruk", email: "faruk@example.com", phone: "4445556667" },
    { id: 48, name: "Sumon", email: "sumon@example.com", phone: "9990001112" },
    { id: 49, name: "Bashir", email: "bashir@example.com", phone: "7778889990" },
    { id: 50, name: "Nadim", email: "nadim@example.com", phone: "3334445556" },
  ]);
  ...
  const paginatedData = computed(() => {
    ...
    // Apply sorting if any column is selected
    if (sortColumn.value) {
      sortedData.sort((a, b) => {
